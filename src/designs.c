...
const Design treble_clef = {

    .numPoints = 1024; //Default //TODO: min:64 max:8192
    .cx;
    .cy;
...
function updateClef(numPts, xScale, yScale)
{
    int i;
    for (i = 0; i <= numPts; i++) {
        float t = (16*Math.PI) / numPts*i;

        float xx = ((-1/12*sin(215/214-18*t)-
        9/17*sin(23/17-12*t)-
        15/22*sin(34/33-10*t)-
        10/13*sin(11/13-8*t)-
        22/29*sin(23/19-6*t)+
